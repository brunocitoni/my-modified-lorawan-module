                                                        ...
                                                        Ptr<MobilityModel> b) const
{
  ...
  NS_LOG_INFO ("TxPowerDbm: " << txPowerDbm << ". Shadowing loss: " << loss << ". Returning: " << txPowerDbm - loss );

  NS_LOG_INFO( "correlated shadowing happening: " << ", input value: "<< txPowerDbm << ", return value: " << txPowerDbm - loss );
