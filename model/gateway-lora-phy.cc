...
// edited by BC according to S=-174+10log(BW)+NF+SNR
// with NF = 6db, SNR = {-7.5,-10-12.5,-15,-17.5,-20}
// info from designer's guide + SX1276 datasheet
const double GatewayLoraPhy::sensitivity[6] = {-124.5, -127, -129.5, -132, -134.53, -137};

//const double GatewayLoraPhy::sensitivity[6] = {-130.0, -132.5, -135.0, -137.5, -140.0, -142.5}; //original
//const double GatewayLoraPhy::sensitivity[6] = {-123, -126, -129, -132, -134.5, -137}; // for math model comparison, from paper
void
...
GatewayLoraPhy::AddFrequency (double frequencyMHz)
{
  ...
  NS_LOG_FUNCTION(this <<m_frequencies.size ());
