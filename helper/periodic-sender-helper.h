...
public:
  ...
  // Added by BC // to make variable random time interval between transmission
  void SetRandomPeriodDelay (double randTimeDelay);
  void SetVariableTX (bool varTx);
  void SetTimedBehaviour (bool timedBeh);


  // MODIFIED BY BC //moved from private to public to be able to print it in main
...
private:
  ...
  // added by BC
  double m_randomTimeDelay;
  bool m_isTxVariable;
  bool m_isBehaviourTimeBased;
